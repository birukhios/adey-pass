  ...
  return (
    <AppShell>
      ...
      <div className="grid gap-4">
        {events.map((event) => (
          <Card className="min-w-0" key={event.id}>
            <div className="grid gap-5 xl:grid-cols-[minmax(0,1fr)_minmax(220px,280px)_auto] xl:items-center">
              <div className="min-w-0">
                <div className="flex flex-wrap items-center gap-3">
                  <h2 className="min-w-0 break-words text-lg font-black sm:text-xl">{event.name}</h2>
              ...
              <div className="grid gap-2 sm:flex sm:flex-wrap xl:flex-col">
