...
export function ReportsClient({ rows, checkedIn, walkIns, pendingVerifications, failedVerifications, duplicateAttempts, organizationSubmissions, gates }: Props) {
  ...
  return (
    <div className="grid gap-5">
      ...
      <div className="md:hidden">
        ...
        {mobileFiltersOpen ? (
          <div className="fixed inset-0 z-50 bg-black/40 p-4">
            <div className="ml-auto h-full w-[min(24rem,92vw)] overflow-y-auto rounded-2xl p-4" style={{ background: "var(--surface)" }}>
      ...
      <Card>
        <h2 className="text-lg font-black sm:text-xl">Export Report</h2>
